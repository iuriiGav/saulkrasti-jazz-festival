...
<!-- <img src="<?php echo esc_url(wp_get_attachment_image_src(get_field('contact_us_image_contact_info_section'), 'ig-featured-portrait')[0]) ?>" alt="<?php esc_html_e(get_post_meta(get_field('contact_us_image_contact_info_section'), '_wp_attachment_image_alt', TRUE), 'saulkrasti-jazz-festival') ?>"> -->
