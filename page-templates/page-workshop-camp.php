...
<section class="workshop__camp mt-5rem full-screen-cover" style="background:  linear-gradient(180deg, #141211 0%, rgba(49, 39, 35, 0.84) 100%), url(<?php ig_saulkrasti_jazz_image_from_field('options_workshop_page_workshop_camp_cover', 'options')
                                                                                                                                            ?>)">
...
<section class="participation-fee full-screen-cover full-screen-cover" style="background-color: var(--color-dark)">>
