...
<footer class="main-footer position-relative">
    ...
    <section class="footer-copyrights">
        ...
        <a class=" footer-developer-link" href="<?php echo esc_url(get_field('options_developer_link', 'options')) ?>"><?php esc_html_e(get_field('options_developer_name', 'options'), 'saulkrasti-jazz-festival') ?>
            </a>
        
        <?php else : ?>
            <a id="developer-email-link-js" class="revrited-color-footer footer-developer-link" href="mailto: iurii.gavryliuk@gmail.com"><?php esc_html_e(get_field('options_developer_name', 'options'), 'saulkrasti-jazz-festival') ?>
            </a>
